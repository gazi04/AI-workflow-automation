...
## Example 1 (Branching Logic): User: "If I get an email from boss@company.com, draft a reply and send me a heads-up. If it's from anyone else, label it 'External'."
{
  ...
  "nodes": {
    ...
    "notify_me": {
      ...
      "config": {
        "type": "send_email",
        "config": { "to": "me@example.com", "subject": "Email from boss", "body": "Email from boss received. Draft created." }
      }
    },
    "label_external": {
      "id": "label_external",
  ...
  "edges": [
    ...
    { "id": "e3", "source": "check_boss", "target": "notify_me", "sourceHandle": "true_path" },
