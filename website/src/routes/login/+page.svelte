...
<div class="flex min-h-screen flex-col items-center justify-center bg-muted/50 p-4">
    <Card.Root class="w-full max-w-md">
        ...
        <Card.Content class="flex flex-col items-center justify-center py-6">
            {#if errorMessage}
                <div class="mb-6 flex w-full items-center gap-3 rounded-lg border border-destructive/50 bg-destructive/10 p-4 text-sm text-destructive animate-in fade-in zoom-in-95">
    ...
    <p class="mt-4 text-xs text-muted-foreground text-center max-w-[280px]">
